...
class EightByEight extends StatefulWidget {
  @override
  EightByEightState createState() => EightByEightState();
}

class EightByEightState extends State<EightByEight>
    with SingleTickerProviderStateMixin {
  AnimationController controller;

  List<List<Tile>> grid =
  List.generate(8, (y) => List.generate(8, (x) => Tile(x, y, 0)));
  List<Tile> toAdd = [];
  ...
  List<List<Tile>> get gridCols =>
      List.generate(8, (x) => List.generate(8, (y) => grid[y][x]));
  ...
  Widget build(BuildContext context) {
    ...
    double tileSize = (gridSize - borderSize * 2) / 8;
