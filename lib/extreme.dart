...
class Extreme extends StatefulWidget {
  @override
  ExtremeState createState() => ExtremeState();
}

class ExtremeState extends State<Extreme>
    with SingleTickerProviderStateMixin {
  AnimationController controller;

  List<List<Tile>> grid =
  List.generate(5, (y) => List.generate(5, (x) => Tile(x, y, 0)));
  List<Tile> toAdd = [];
  ...
  List<List<Tile>> get gridCols =>
      List.generate(5, (x) => List.generate(5, (y) => grid[y][x]));
  ...
  Widget build(BuildContext context) {
    ...
    double tileSize = (gridSize - borderSize * 2) / 5;
