...
class ThreeByThreeState extends State<ThreeByThree>
    with SingleTickerProviderStateMixin {
  AnimationController controller;

  List<List<Tile>> grid =
  List.generate(3, (y) => List.generate(3, (x) => Tile(x, y, 0)));
  List<Tile> toAdd = [];
  ...
  List<List<Tile>> get gridCols =>
      List.generate(3, (x) => List.generate(3, (y) => grid[y][x]));
  ...
  Widget build(BuildContext context) {
    ...
    double tileSize = (gridSize - borderSize * 2) / 3;
